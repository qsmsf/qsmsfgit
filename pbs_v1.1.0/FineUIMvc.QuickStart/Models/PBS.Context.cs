...
namespace FineUIMvc.QuickStart.Models
{
    ...
    public partial class pbsEntities : DbContext
    {
        ...
        public virtual ObjectResult<sys_unit> showChildUnits(Nullable<int> unitId)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sys_unit>("showChildUnits", unitIdParameter);
        }
    
        public virtual ObjectResult<sys_unit> showChildUnits(Nullable<int> unitId, MergeOption mergeOption)
        {
            var unitIdParameter = unitId.HasValue ?
                new ObjectParameter("unitId", unitId) :
                new ObjectParameter("unitId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sys_unit>("showChildUnits", mergeOption, unitIdParameter);
        }
    }
}
